...
class Network {
  ...
  getTendermint() {
    return `${this.config.protocol}://${this.config.host}:${this.config.tendermintport}`;
  }
  /**
  ...
  async getTxnStatus(handle) {
    const status = await axios.get(
      `${this.getSubmitRoute()}/txn_status/${handle}`
    );
    return status.data;
  }
  ...
  async submitTransaction(txn) {
    const handle = await axios.post(
      `${this.getSubmitRoute()}/submit_transaction`,
      JSON.parse(txn)
    );
    return handle.data;
  }
  ...
  async getAsset(code) {
    const asset = await axios.get(
      `${this.getLedgerRoute()}/asset_token/${code}`
    );
    return asset.data;
  }
  ...
  async getIssuanceNum(code) {
    const asset = await axios.get(
      `${this.getLedgerRoute()}/asset_issuance_num/${code}`
    );
    return asset.data;
  }
  ...
  async getStateCommitment() {
    const stateCommitment = await axios.get(
      `${this.getLedgerRoute()}/global_state`
    );
  ...
  async getRelatedSids(address) {
    const sids = await axios.get(
      `${this.getQueryRoute()}/get_related_txns/${address}`
    );
    return sids.data;
  }
  ...
  async getRelatedXfrs(code) {
    const sids = await axios.get(
      `${this.getQueryRoute()}/get_related_xfrs/${code}`
    );
  ...
  async getOwnedSids(address) {
    const sids = await axios.get(
      `${this.getQueryRoute()}/get_owned_utxos/${address}`
    );
    return sids.data;
  }
  ...
  async getOwnerMemo(utxoSid) {
    const memo = await axios.get(
      `${this.getQueryRoute()}/get_owner_memo/${utxoSid}`
    );
    return memo.data;
  }
  ...
  async getCreatedAssets(address) {
    const sids = await axios.get(
      `${this.getQueryRoute()}/get_created_assets/${address}`
    );
    return sids.data;
  }
  ...
  async getTracedAssets(address) {
    const sids = await axios.get(
      `${this.getQueryRoute()}/get_traced_assets/${address}`
    );
    return sids.data;
  }
  ...
  async getCustomData(key) {
    const result = await axios.get(
      `${this.getQueryRoute()}/get_custom_data/${key}`
    );
    return result.data;
  }
  ...
  async storeCustomData(customData) {
    const result = await axios.post(
      `${this.getQueryRoute()}/store_custom_data`,
      customData
    );
    return result.data;
  }
  ...
  async getIssuedRecords(address) {
    const records = await axios.get(
      `${this.getQueryRoute()}/get_issued_records/${address}`
    );
    return records.data;
  }
  ...
  async getUnconfirmed() {
    const result = await axios.get(
      `${this.getTendermint()}/num_unconfirmed_txs`
    );
    return result.data;
  }
}
